...
import com.sinosoft.type.ApplicationTagVirtualMachineInfo;
...
public class ApplicationTagServiceImpl implements ApplicationTagService {
	...
	public Map<String, Object> getApplicationTagEntries(int pageNo, int pageSize) {
		...
		List<com.sinosoft.type.ApplicationTag> applicationTags = new ArrayList<com.sinosoft.type.ApplicationTag>();
		for (ApplicationTag tag : tags) {
			com.sinosoft.type.ApplicationTag applicationTag = buildApplicationTagValue(tag);
	 ...
	 * @author xiangqian
	 */
	private com.sinosoft.type.ApplicationTag buildApplicationTagValue(ApplicationTag applicationTag) {
		com.sinosoft.type.ApplicationTag applicationTagValue = new com.sinosoft.type.ApplicationTag();
	...
	public List<com.sinosoft.type.ApplicationTag> getList() {
		List<com.sinosoft.type.ApplicationTag> applicationTags = new ArrayList<com.sinosoft.type.ApplicationTag>();
