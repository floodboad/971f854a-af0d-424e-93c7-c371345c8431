...
public class VirtualMachineServiceImpl implements VirtualMachineService {
	...
	public com.sinosoft.type.VirtualMachine getVirtualMachineById(String id) {
		VirtualMachine machine = VirtualMachine.getVirtualMachine(id);
		if (machine == null) {
			return null;
		}

		com.sinosoft.type.VirtualMachine machineValue = buildVirtualMachineValue(machine);
		return machineValue;
	}
	 ...
	 * @author xiangqian
	 */
	private com.sinosoft.type.VirtualMachine buildVirtualMachineValue(VirtualMachine machine) {
		com.sinosoft.type.VirtualMachine machineValue = new com.sinosoft.type.VirtualMachine();
		...
		List<com.sinosoft.type.ApplicationTag> applications = new ArrayList<com.sinosoft.type.ApplicationTag>();
		...
		for (ApplicationTag machineApplicationTag : machineApplicationTags) {
			com.sinosoft.type.ApplicationTag application = new com.sinosoft.type.ApplicationTag();
	...
	public List<com.sinosoft.type.VirtualMachine> getVirtualMachinesByHypervisorName(String hypervisorName) {
		List<com.sinosoft.type.VirtualMachine> machineValueList = new ArrayList<com.sinosoft.type.VirtualMachine>();
