...
public class MonitorLogServiceImpl implements MonitorLogService {
	public Map<String, Object> getMonitorLogEntries(String username, String role, int pageNo, int pageSize,
		...
		List<com.sinosoft.type.MonitorLog> monitorLogs = new ArrayList<com.sinosoft.type.MonitorLog>();
		for (MonitorLog log : logs) {
			com.sinosoft.type.MonitorLog monitorLogValue = buildMonitorLogValue(log);
	 ...
	 * @author xiangqian
	 */
	private com.sinosoft.type.MonitorLog buildMonitorLogValue(MonitorLog monitorLog) {
		com.sinosoft.type.MonitorLog monitorLogValue = new com.sinosoft.type.MonitorLog();
