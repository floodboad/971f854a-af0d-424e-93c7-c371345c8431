...
public class ImageServiceImpl implements ImageService {
	...
	public Map<String, Object> getList(int pageNo, int pageSize) {
		...
		List<com.sinosoft.type.Image> imageList = new ArrayList<com.sinosoft.type.Image>();
		for (Image image : pageImages) {
			com.sinosoft.type.Image imageValue = buildImageValue(image);
	...
	public List<com.sinosoft.type.Image> getAllInOneList() {
		List<com.sinosoft.type.Image> imageList = new ArrayList<com.sinosoft.type.Image>();
	...
	private com.sinosoft.type.Image buildImageValue(Image image) {
		com.sinosoft.type.Image imageValue = new com.sinosoft.type.Image();
