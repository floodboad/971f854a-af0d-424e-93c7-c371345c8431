...
public class DiskServiceImpl implements DiskService {
	...
	public List<com.sinosoft.type.Disk> getList(List<String> diskIds) {
		List<com.sinosoft.type.Disk> diskList = new ArrayList<com.sinosoft.type.Disk>();

		for (String diskId : diskIds) {
			Disk disk = Disk.getDisk(diskId);
			com.sinosoft.type.Disk diskValue = buildDiskValue(disk);
	 ...
	 * @author xiangqian
	 */
	private com.sinosoft.type.Disk buildDiskValue(Disk disk) {
		com.sinosoft.type.Disk diskValue = new com.sinosoft.type.Disk();
	...
	public com.sinosoft.type.Disk getDiskById(String diskId) {
		com.sinosoft.type.Disk diskValue = new com.sinosoft.type.Disk();
	...
	public List<com.sinosoft.type.Disk> getUserAvailableDisks(String manager) {
		List<com.sinosoft.type.Disk> diskList = new ArrayList<com.sinosoft.type.Disk>();
	...
	public List<com.sinosoft.type.Disk> getDisksByVirtualMachine(String vmId) {
		List<com.sinosoft.type.Disk> diskList = new ArrayList<com.sinosoft.type.Disk>();
		...
		for (Disk disk : disks) {
			com.sinosoft.type.Disk diskValue = getDiskById(disk.getDiskId());
			if (null != diskValue) {
				diskList.add(diskValue);
			}
		}
