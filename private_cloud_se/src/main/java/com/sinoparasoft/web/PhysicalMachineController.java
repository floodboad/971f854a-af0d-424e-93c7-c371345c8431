...
import com.sinoparasoft.service.MonitorResultService;
import com.sinoparasoft.service.MonitorSettingService;
import com.sinoparasoft.service.OperationLogService;
import com.sinoparasoft.service.PhysicalMachineService;
...
public class PhysicalMachineController {
	...
	public Map<String, Object> getJsonList() {
		...
		try {
			List<com.sinoparasoft.type.PhysicalMachine> controllerNodes = physicalMachineService
					.getList(PhysicalMachineTypeNameEnum.CONTROLLER_NODE);
			List<com.sinoparasoft.type.PhysicalMachine> networkNodes = physicalMachineService
					.getList(PhysicalMachineTypeNameEnum.NETWORK_NODE);
			List<com.sinoparasoft.type.PhysicalMachine> computeNodes = physicalMachineService
	...
	public Map<String, Object> getJsonDetail(@PathVariable("id") String hostId) {
		...
		try {
			com.sinoparasoft.type.PhysicalMachine machineValue = physicalMachineService.getPhysicalMachine(hostId);
			map.put("machine", machineValue);

			List<com.sinoparasoft.type.VirtualMachine> instances = physicalMachineService.getVirtualMachines(hostId);
	...
	public @ResponseBody Map<String, Object> getLoadMonitorSettings(@PathVariable("id") String hostId) {
		...
		try {
			List<com.sinoparasoft.type.MonitorSetting> monitorSettings = monitorSettingService.getMonitorSettings(hostId,
					MonitorTypeEnum.LOAD);
			map.put("status", "ok");
			map.put("message", "");
	...
	public Map<String, Object> getMigrationPolicies(@PathVariable("id") String hostId) {
		...
		try {
			 ...
			 */
			List<com.sinoparasoft.type.VirtualMachine> machines = virtualMachineService
					.getVirtualMachinesByHypervisorName(physicalMachine.getHostName());
			Collections.sort(machines, new Comparator<com.sinoparasoft.type.VirtualMachine>() {
				@Override
				public int compare(com.sinoparasoft.type.VirtualMachine o1, com.sinoparasoft.type.VirtualMachine o2) {
			...
			for (com.sinoparasoft.type.PhysicalMachine machineValue : computeNodes) {
			 ...
			 */
			for (com.sinoparasoft.type.VirtualMachine machine : machines) {
