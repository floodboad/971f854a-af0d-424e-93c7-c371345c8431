...
import com.sinoparasoft.type.SnapshotVirtualMachineInfo;
...
public class SnapshotServiceImpl implements SnapshotService {
	...
	public Map<String, Object> getList(String userName, String role, int pageNo, int pageSize) {
		...
		List<com.sinoparasoft.type.Snapshot> snapshotList = new ArrayList<com.sinoparasoft.type.Snapshot>();
		for (Snapshot snapshot : snapshots) {
			com.sinoparasoft.type.Snapshot snapshotValue = buildSnapshotValue(snapshot);
	...
	public List<com.sinoparasoft.type.Snapshot> getListByVirtualMachine(String vmId) {
		...
		List<com.sinoparasoft.type.Snapshot> snapshotValueList = new ArrayList<com.sinoparasoft.type.Snapshot>();
		for (Snapshot snapshot : snapshots) {
			com.sinoparasoft.type.Snapshot snapshotValue = buildSnapshotValue(snapshot);
	 ...
	 * @author xiangqian
	 */
	private com.sinoparasoft.type.Snapshot buildSnapshotValue(Snapshot snapshot) {
		com.sinoparasoft.type.Snapshot snapshotValue = new com.sinoparasoft.type.Snapshot();
