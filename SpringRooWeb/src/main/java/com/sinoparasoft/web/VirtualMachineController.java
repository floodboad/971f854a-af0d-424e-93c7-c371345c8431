...
import com.sinoparasoft.service.DiskService;
...
import com.sinoparasoft.type.Disk;
...
public class VirtualMachineController {
	...
	public Map<String, Object> getJsonList(@RequestParam("pageNo") int pageNo) {
		...
		try {
			...
			List<com.sinoparasoft.type.VirtualMachine> machineList = new ArrayList<com.sinoparasoft.type.VirtualMachine>();
			for (VirtualMachine machine : machines) {
				com.sinoparasoft.type.VirtualMachine machineValue = virtualMachineService
	...
	public Map<String, Object> getMachineInfo(@PathVariable("id") String id) {
		...
		try {
			com.sinoparasoft.type.VirtualMachine machineValue = virtualMachineService.getVirtualMachineById(id);
	...
	public Map<String, Object> getLoadMonitorSettings(@PathVariable("id") String id) {
		...
		try {
			List<com.sinoparasoft.type.MonitorSetting> monitorSettings = monitorSettingService.getMonitorSettings(id,
	...
	public Map<String, Object> getSnapshots(@PathVariable("id") String id) {
		...
		try {
			List<com.sinoparasoft.type.Snapshot> snapshotList = snapshotService.getListByVirtualMachine(id);
