...
public class NetworkServiceImpl implements NetworkService {
	...
	public Map<String, Object> getExternalIpEntries(int pageNo, int pageSize, String ip, String status) {
		...
		List<ExternalIp> eIps = ExternalIp.getExternalIpEntries(ip, status, (pageNo - 1) * pageSize, pageSize, "ip",
				"ASC");
		List<com.sinoparasoft.type.ExternalIp> externalIps = new ArrayList<com.sinoparasoft.type.ExternalIp>();
		for (ExternalIp eIp : eIps) {
			com.sinoparasoft.type.ExternalIp externalIp = buildExternalIpValue(eIp);
	...
	private com.sinoparasoft.type.ExternalIp buildExternalIpValue(ExternalIp externalIp) {
		com.sinoparasoft.type.ExternalIp externalIpValue = new com.sinoparasoft.type.ExternalIp();
	...
	public ActionResult createFloatingIp(String username, String ipAddress, String vmId) {
		...
		CloudManipulator cloud = CloudManipulatorFactory.createCloudManipulator(cloudConfig,
				cloudConfig.getAdminProjectId());
		com.sinoparasoft.openstack.type.ActionResult createResult = cloud.createFloatingIp(ipAddress, vmId);
	...
	public ActionResult deleteFloatingIp(String username, String ipAddress, String vmId) {
		...
		CloudManipulator cloud = CloudManipulatorFactory.createCloudManipulator(cloudConfig,
				cloudConfig.getAdminProjectId());
		com.sinoparasoft.openstack.type.ActionResult deleteResult = cloud.deleteFloatingIp(ipAddress);
