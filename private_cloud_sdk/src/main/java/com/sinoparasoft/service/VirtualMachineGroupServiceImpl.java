...
public class VirtualMachineGroupServiceImpl implements VirtualMachineGroupService {
	...
	public com.sinoparasoft.type.VirtualMachineGroup getGroupById(String groupId) {
		VirtualMachineGroup group = VirtualMachineGroup.getGroup(groupId);
		if (null == group) {
			return null;
		}

		com.sinoparasoft.type.VirtualMachineGroup groupValue = buildVirtualMachineGroupValue(group);
		return groupValue;
	}
	 ...
	 * @author xiangqian
	 */
	private com.sinoparasoft.type.VirtualMachineGroup buildVirtualMachineGroupValue(VirtualMachineGroup group) {
		com.sinoparasoft.type.VirtualMachineGroup groupValue = new com.sinoparasoft.type.VirtualMachineGroup();
